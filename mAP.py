...
Precision = TP / (TP + FP)
Recall = TP / (TP + FN)
A battle between precision and recall, different applications may prioritize different metrics.
...
def mean_average_precision(pred_boxes, true_boxes, iou_threshold=0.5, box_format="corners", num_classes=20):
    ...
    :param pred_boxes: list, [[train_idx, class_pred, prob_score, x1, y1, x2, y2], ...]
    :param true_boxes:
    :param iou_threshold:
    :param box_format:
    :param num_classes:
    ...
    for c in range(num_classes):
        ...
        # img 0 has 3 bboxes
        # img 1 has 5 bboxes
        # amount_bboxes = {0:3, 1:5} {train_idx: num_bboxes}
